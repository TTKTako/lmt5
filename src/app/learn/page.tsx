...
const coursesConfig: Record<string, CourseConfig> = {
  ...
  Software: {
    ...
    slides: [
      ...
      { id: 3, title: 'CSS Lab 2: Basic CSS', url: '/websiteLab/CSS2BasicProperty.zip', visible: true, download: true },
      { id: 4, title: 'CSS Lab 3: Basic CSS', url: '/websiteLab/CSS3Selector.zip', visible: true, download: true },
      { id: 5, title: 'CSS Lab 4: Basic CSS', url: '/websiteLab/CSS4OtherProperty.zip', visible: true, download: true },
      { id: 6, title: 'CSS Lab 5: Basic CSS', url: '/websiteLab/CSS5BoxProperty.zip', visible: true, download: true },
      ...
      { id: 9, title: 'Practice Lab 2: Spanish Color', url: '/websiteLab/Practice2_SpanishColor.zip', visible: true, download: true },
    ],
