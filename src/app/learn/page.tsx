...
const coursesConfig: Record<string, CourseConfig> = {
  Python: {
    ...
    slides: [
      ...
      { id: 1, title: 'Introduction to Python [Answer Key]', url: 'https://www.canva.com/design/DAG1UIKzaAw/-veXNI0lSRcA2HZ1EhxZPQ/view?utm_content=DAG1UIKzaAw&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=h957e561774', visible: false },
      { id: 2, title: 'Python Applications [Answer Key]', url: 'https://www.canva.com/design/DAG1UGyjIjA/KqSEn_9xcOxtd0hxyDWS1Q/view?utm_content=DAG1UGyjIjA&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=h1c4444ef8d', visible: false },
    ],
  ...
  Software: {
    ...
    hasIDE: true,
    slides: [
      { id: 1, title: 'Website Development Slide', url: '/Web_Development_compressed.pdf', visible: false },
      ...
      { id: 7, title: 'HTML Lab: Example', url: '/websiteLab/HTML_example.zip', visible: false, download: true },
